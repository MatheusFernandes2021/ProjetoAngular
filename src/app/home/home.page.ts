...
export class HomePage {
  ...
  setSeguir(){
    (this.Seguir_Status == 'Seguir' ? this.Seguir_Status = 'Seguindo' : this.Seguir_Status = 'Seguir'),
    (this.Seguir_Status == 'Seguindo' ? this.metricas_sociais.seguidores += 1 : this.metricas_sociais.seguidores -= 1)
